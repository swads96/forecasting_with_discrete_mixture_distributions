...
outbreaks and problems in other fields. When collecting forecasts from 
...
probability density functions, samples, binned distributions and  quantile 
forecasts and compares
their usage within the context of collaborative projects. The discrete mixture
distribution forecast format is presented as an attractive alternative to the 
former formats due to the flexibility such a forecast may have in shape as well
as the relatively low loss of information due to limited computer storage.
...
format. During previous fluw seasons the binning scheme was on a bounded numeric 
scale and the 
...
the forecasts were requested as the predictive median and 
...
\caption{This graphic was published on cdc.gov as official public communication 
...
many predictions are collected, computer storage may be something
that needs to be addressed. As an example of required computer storage, the 
repository for the
...
ensemble model outperforms the individual components.
...
\label{eq:logs}
  LS(p_m,x*) = -log\;p_m(x^*)
\end{equation}
The goal is to minimize the LogS, so that a forecast $p^{'}_m(x^*)$ is considered 
superior to $p_m$ if
$LS(p^{'}_m, x^*) < LS(p_m, x^*)$.
...
and so 
can be used a more extensively than the LogS. 
...
used
to build ensembles using Bayesian model averaging (BMA). Considered the state-of-the-art techniques for combining 
...
of weights)
and minimizing the ensemble CRPS as in 
...
\centering
 ...
 \hline
 \end{tabular}
 \caption{lognormal distribution with parameters $\mu = $ 1 and $\sigma =$ 0.4}
 \label{table:pstor}
\end{table}
...
corresponding probabilities in each. That made 262 pieces of information per
...
\centering
 ...
 \end{tabular}
  \caption{This table displays subset of bins and probabilities in each for a Lognormal distribution
with $\mu = 1$ and $\sigma = 0.4$ after discretization}
\label{table:dbins}
\end{table}
...
requires much less storage than possible thousands of draws from a sample 
distribution but is 
...
nothing is known about the tails or the uncertainty or ouside of the most 
extreme reported quantile values. In the Forecast Hub predictions, nothing 
is said about the range below the $1^{st}$ quantile or above the $99^{th}$.
...
but another proper scoring rule the interval score (IS) may be used.
...
\centering
 ...
 \hline
 \end{tabular}
 \caption{A table showing a subset of quantiles and values of a Lognormal
 distribution with $\mu=1$ and $\sigma = 0.4$}
 \label{table:qstor}
\end{table}


\begin{figure}[htbp]
\centerline{\includegraphics[scale=.1]{dens_comp.png}}
\caption{Figure this out later}
\label{fig}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[scale=.1]{cum_comp.png}}
\caption{Figure this out later}
\label{fig}
\end{figure}
...
ensemble described under section \ref{section:pardist} in equation 
(\ref{eq:bma}) 
...
using the LogS, CRPS and IS. The resolution of a discrete mixture is continuous 
...
% \centering
%     \subfloat[label 1]{{\includegraphics[width=1cm]{flu_fit_img/_flu_fit_1_10_2_.png} }}
%     \qquad
%     \subfloat[label 2]{{\includegraphics[width=1cm]{flu_fit_img/_flu_fit_1_10_6_.png} }}
%     \caption{2 Figures side by side}
%     \label{fig:example}
% % \includegraphics[height=5.4cm]{flu_fit_img/_flu_fit_1_10_2_.png}
% % \includegraphics[height=5.4cm]{flu_fit_img/_flu_fit_1_10_6_.png}
% % \includegraphics[height=5.4cm]{flu_fit_img/_flu_fit_3_11_2_.png}
% % \includegraphics[height=5.4cm]{flu_fit_img/_flu_fit_3_11_4_.png}
...
% 
%     \centering
%     \subfloat[1]{{\includegraphics[width=0.5\textwidth]{flu_fit_img/_flu_fit_1_10_2_.png}}}
%     \hfill
%     \subfloat[2]{{\includegraphics[width=0.5\textwidth]{flu_fit_img/_flu_fit_1_10_6_.png}}}
%     \hfill
%     \subfloat[1]{{\includegraphics[width=0.5\textwidth]{flu_fit_img/_flu_fit_3_11_2_.png}}}
%     \hfill
%     \subfloat[2]{{\includegraphics[width=0.5\textwidth]{flu_fit_img/_flu_fit_3_11_4_.png}}}
% 
%     \subfloat[1]{{\includegraphics[width=0.5\textwidth]{flu_fit_img/_flu_fit_5_6_1_.png}}}
%     \hfill
%     \subfloat[2]{{\includegraphics[width=0.5\textwidth]{flu_fit_img/_flu_fit_5_6_2_.png}}}
%     \hfill
%     \subfloat[1]{{\includegraphics[width=0.5\textwidth]{flu_fit_img/_flu_fit_5_10_4_.png}}}
%     \hfill
%     \subfloat[2]{{\includegraphics[width=0.5\textwidth]{flu_fit_img/_flu_fit_5_10_6_.png}}}    
%     \caption{graphs}%
% 
% \end{figure}
% \end{adjustwidth}
...
\begin{figure}[htbp]
\centerline{\includegraphics[scale=.15]{mix_dists.png}}
\caption{Figure this out later}
\label{figmixs}
\end{figure}
...
submission format may face hurdles. A forecast hub, along with modelers, using a 
